...
class APF:
    ...
    def __init__(self):
        ...
        self.min_ang_vel = params["vel_theta_min"]

        self.max_lin_acc = params["acc_x_lim"]
        self.max_ang_acc = params["acc_theta_lim"]

        self.init_kp = params["init_kp"]
        self.init_eta = params["init_eta"]

        self.init_linear_kp = params["init_linear_kp"]
        self.init_angular_kp = params["init_angular_kp"]
        self.init_angular_kd = params["init_angular_kd"]
