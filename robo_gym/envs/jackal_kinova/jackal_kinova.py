...
class Obstacle_Avoidance_Jackal_Kinova(gym.Env):
    ...
    def _get_robot_server_state_len(self):
        ...
        rs_state = target + husky_pose + husky_twist + scan + [collision] + obstacles + rostime
    ...
    def _get_target(self, robot_coordinates):
        ...
        x_t = self.np_random.uniform(low=7.5, high=7.9)
