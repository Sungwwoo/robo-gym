...
models_dir = "models/e2e_rl_PPO_2"
logdir = "logs"
...
model = PPO("MlpPolicy", env, policy_kwargs=policy_kwarg, n_steps=512, verbose=1, tensorboard_log="./logs")
...
while i < 250:
    ...
    #     continue
    model.learn(total_timesteps=TIMESTEPS, reset_num_timesteps=False, tb_log_name="e2e_rl_ppo_2")
    model.save(f"{models_dir}/{TIMESTEPS*i}")
    print("Error count: ", err_count)
    i = i + 1
